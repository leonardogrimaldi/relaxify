<div class="max-w-xs sm:max-w-2xl bg-white shadow-md rounded-lg sm:ml-auto sm:mr-auto w-full">
    ...
    <div class="flex flex-col sm:flex-row sm:mb-4">
        <p class="text-center hidden mb-4" id="emptyText">Il tuo carrello Relaxify è vuoto. Vai alla <a class="font-medium text-blue-600 underline hover:no-underline" href="./index.php">homepage</a> per visualizzare gli articoli presenti nello store!</p>
                ...
                <article data-codice-articolo="<?php echo $prodottocarrello["prodottoID"]; ?>" class="flex justify-between sm:justify-evenly border-2 p-1 rounded-md">
                    ...
                    <div class="flex flex-col justify-center items-center gap-y-2 w-full">
                        ...
                        <div class="flex items-center justify-center gap-x-4 w-full">
                            <button data-codice-articolo="<?php echo $prodottocarrello["prodottoID"]; ?>" onclick="decreaseQuantity(this)" type="button" class="bg-teal-500 text-white p-2 rounded-lg hover:bg-teal-600">
                            ...
                            <button data-codice-articolo="<?php echo $prodottocarrello["prodottoID"]; ?>" onclick="incrementQuantity(this)" type="button" class="bg-teal-500 text-white p-2 rounded-lg hover:bg-teal-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="flex items-center">
                        <button data-codice-articolo="<?php echo $prodottocarrello["prodottoID"]; ?>" onclick="removeItem(this)" type="button" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
