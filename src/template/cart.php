                ...
                <article data-codice-articolo="1" class="flex justify-between sm:justify-evenly border-2 p-1 rounded-md">
                    ...
                    <div class="flex flex-col justify-center items-center gap-y-2">
                        ...
                        <div class="flex items-center justify-evenly w-full">
                            ...
                            <button data-prodotto-id="<?php echo $prodottocarrello["prodottoID"]; ?>" onclick="incrementQuantity(this)" type="button" class="addToCart bg-teal-500 text-white p-2 rounded-lg hover:bg-teal-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="flex items-center">
                        <button data-prodotto-id="<?php echo $prodottocarrello["prodottoID"]; ?>" data-codice-articolo="1" onclick="removeItem(this)" type="button" class="removeFromCart bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
