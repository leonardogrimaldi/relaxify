    ...
    <div class="flex flex-col sm:flex-row sm:mb-4">
        ...
        <section class="sm:w-3/5 sm:border-r sm:px-4 mx-1 flex flex-col">
            ...
            <article data-codice-articolo="1" class="flex justify-between sm:justify-evenly border-2 p-1 rounded-md">
                <img class="aspect-square rounded-lg" width="100" height="100" src="resources/img/cube.jpg" alt="Cubo Antistress">
                <div class="flex flex-col justify-center items-center gap-y-2">
                    ...
                    <div class="flex items-center justify-evenly w-full">
                        ...
                        <p class="sr-only">Quantità:</p><span id="quantity-1" class="text-lg font-semibold">1</span>
                        <button data-codice-articolo="1" onclick="incrementQuantity(this)" type="button" class="bg-teal-500 text-white p-2 rounded-lg hover:bg-teal-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <div class="flex items-center">
                    <button data-codice-articolo="1" onclick="removeItem(this)" type="button" class="bg-red-500 text-white p-2 rounded-lg hover:bg-red-600 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
