<section class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
    <h2 class="text-3xl font-bold text-pink-500 mb-6 text-center" itemprop="name">Contatti</h2>
    <p class="text-lg text-gray-700 mb-4">
        Benvenuto su <strong>Relaxify</strong>, hai domande, richieste o semplicemente vuoi sapere di più sui nostri prodotti? Siamo qui per te! Il nostro team è sempre disponibile per ascoltarti e offrirti supporto. Non esitare a contattarci tramite i canali che preferisci. La tua soddisfazione è la nostra priorità!
    </p>
