        ...
        <article itemscope itemtype="https://schema.org/Product" class="bg-white rounded-lg flex flex-col overflow-hidden shadow-md">
            ...
            <div class="text-center h-full flex flex-col">
                ...
                <?php if(isUserLoggedIn()): ?>
                    ...
                    <button type="button" class="addToCart w-10 flex justify-center bg-teal-500 text-white p-2 rounded hover:bg-teal-600" data-prodotto-id="<?php echo $prodottocat["prodottoID"]; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
