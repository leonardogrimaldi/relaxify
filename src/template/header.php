<header class="bg-pink-300 text-white flex items-center w-full">
    ...
    <!-- Title -->
    <a class="text-4xl py-5 font-bold w-full flex" href="./homepage.php">
    ...
    <div id="barra" class="absolute top-0 left-0 w-64 h-auto bg-white shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out z-50">
        <div class="p-6 flex flex-col space-y-4">
            ...
            <div class="space-y-4">
                <a href="homepage.html" class="flex items-center text-gray-800 hover:text-teal-600">
                ...
                <a href="login.html" class="flex items-center text-gray-800 hover:text-teal-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
